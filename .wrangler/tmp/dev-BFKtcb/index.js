...
// .wrangler/tmp/bundle-phepal/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-phepal/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-phepal/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
function parseAlertasData(alertas) {
  ...
  try {
    ...
    if (parsed && Array.isArray(parsed.alertas))
      return { alertas: parsed.alertas, resumo: parsed.resumo, detalhesExtraidos: parsed.detalhesExtraidos };
    return { alertas: [] };
  } catch {
    return { alertas: [] };
  }
...
var CLASSIFICACAO_PESSOAL = [
  ...
  { codigo: "319004", descricao: "Contrata\xC3\xA7\xC3\xA3o por Tempo Determinado", vinculos: ["TEMPORARIO"] },
  { codigo: "31900401", descricao: "Contrata\xC3\xA7\xC3\xA3o por Tempo Determinado", vinculos: ["TEMPORARIO"] },
  ...
  { codigo: "31901103", descricao: "Subs\xC3\xADdio", vinculos: ["COMISSIONADO", "EFETIVO"] },
  { codigo: "31901113", descricao: "Gratifica\xC3\xA7\xC3\xA3o por exerc\xC3\xADcio de cargo", vinculos: ["COMISSIONADO"] },
  { codigo: "31901122", descricao: "Gratifica\xC3\xA7\xC3\xA3o de tempo de servi\xC3\xA7o", vinculos: ["EFETIVO"] },
  { codigo: "31901130", descricao: "Vencimentos de cargo em comiss\xC3\xA3o", vinculos: ["COMISSIONADO"] },
  { codigo: "31901134", descricao: "Gratifica\xC3\xA7\xC3\xA3o natalina (13\xC2\xBA)", vinculos: ["EFETIVO", "COMISSIONADO"] },
  { codigo: "31901140", descricao: "Sal\xC3\xA1rio-fam\xC3\xADlia", vinculos: ["EFETIVO"] },
  { codigo: "31901141", descricao: "F\xC3\xA9rias \xE2\u20AC\u201C abono constitucional", vinculos: ["EFETIVO", "COMISSIONADO"] },
  { codigo: "31901144", descricao: "F\xC3\xA9rias indenizadas", vinculos: ["EFETIVO", "COMISSIONADO"] },
  { codigo: "31901146", descricao: "Aux\xC3\xADlio-alimenta\xC3\xA7\xC3\xA3o", vinculos: ["EFETIVO", "COMISSIONADO"] },
  { codigo: "31901199", descricao: "Outras vantagens fixas \xE2\u20AC\u201C pessoal civil", vinculos: ["EFETIVO"] },
  // â”€â”€ 3.1.90.13 â€“ ObrigaÃ§Ãµes Patronais â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  { codigo: "319013", descricao: "Obriga\xC3\xA7\xC3\xB5es Patronais", vinculos: ["EFETIVO", "COMISSIONADO", "TEMPORARIO"] },
  // â”€â”€ 3.1.90.16 â€“ Outras Despesas VariÃ¡veis â€“ Pessoal Civil â”€â”€â”€â”€â”€
  { codigo: "319016", descricao: "Outras Despesas Vari\xC3\xA1veis \xE2\u20AC\u201C Pessoal Civil", vinculos: ["EFETIVO"] },
  ...
  { codigo: "319091", descricao: "Senten\xC3\xA7as Judiciais", vinculos: ["EFETIVO", "COMISSIONADO", "TEMPORARIO"] },
  // â”€â”€ 3.1.90.92 â€“ Despesas de ExercÃ­cios Anteriores â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  { codigo: "319092", descricao: "Despesas de Exerc\xC3\xADcios Anteriores", vinculos: ["EFETIVO", "COMISSIONADO", "TEMPORARIO"] },
  // â”€â”€ 3.1.90.94 â€“ IndenizaÃ§Ãµes e RestituiÃ§Ãµes Trabalhistas â”€â”€â”€â”€â”€â”€
  { codigo: "319094", descricao: "Indeniza\xC3\xA7\xC3\xB5es e Restitui\xC3\xA7\xC3\xB5es Trabalhistas", vinculos: ["EFETIVO"] },
  { codigo: "31909401", descricao: "Indeniza\xC3\xA7\xC3\xB5es Trabalhistas \xE2\u20AC\u201C servidor efetivo", vinculos: ["EFETIVO"] },
  // â”€â”€ 3.1.91.13 â€“ ObrigaÃ§Ãµes Patronais â€“ Intra-OFSS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  { codigo: "319113", descricao: "Obriga\xC3\xA7\xC3\xB5es Patronais \xE2\u20AC\u201C Intra-OFSS (RPPS)", vinculos: ["EFETIVO"] },
  ...
  for (const row of rows) {
    ...
    if (count === 2) {
      alertas.push({
        ...
        descricao: "Poss\xC3\xADvel pagamento duplicado detectado",
        pontuacao: 20,
    ...
    for (const v of valores) {
      ...
      if (zscore > ZSCORE_THRESHOLD) {
        alertas.push({
          ...
          descricao: "Valor significativamente acima da m\xC3\xA9dia para o mesmo objeto",
          pontuacao: 20,
          detalhes: `Objeto: ${objeto} | Valor: R$ ${v.toLocaleString("pt-BR", { minimumFractionDigits: 2 })} | M\xC3\xA9dia: R$ ${media.toLocaleString("pt-BR", { minimumFractionDigits: 2 })} | Z-score: ${zscore.toFixed(1)}`
        });
      }
    }
  }
  ...
  for (const [chave, itens] of grupos) {
    ...
    if (total > LIMITE_DISPENSA_SERVICOS && maiorIndividual <= LIMITE_DISPENSA_SERVICOS) {
      ...
      alertas.push({
        ...
        descricao: "Poss\xC3\xADvel fracionamento de licita\xC3\xA7\xC3\xA3o para evitar limite de dispensa",
        pontuacao: 20,
...
function regraConcentracaoFimAno(rows) {
  ...
  if (total > 0 && fimAno / total > 0.5) {
    return [{
      ...
      descricao: "Concentra\xC3\xA7\xC3\xA3o anormal de empenhos no fim do exerc\xC3\xADcio (nov/dez)",
      pontuacao: 10,
...
function regraCnpjInvalido(rows) {
  ...
  for (const row of rows) {
    ...
    if (!validarCnpj(limpo)) {
      alertas.push({
        tipo: "CNPJ_INVALIDO",
        descricao: "CNPJ com d\xC3\xADgitos verificadores inv\xC3\xA1lidos",
        pontuacao: 15,
...
function regraEmpSemDotacao(rows) {
  const alertas = [];
  for (const row of rows) {
    const dotacao = campo(row, "dotacao", "dota\xC3\xA7\xC3\xA3o", "classificacao", "funcional");
    ...
    const temCamposDotacao = Object.keys(row).some(
      (k) => k.includes("dotacao") || k.includes("dota\xC3\xA7\xC3\xA3o") || k.includes("elemento") || k.includes("natureza") || k.includes("fonte")
    );
    if (temCamposDotacao && !dotacao && !fonte && !elemento) {
      alertas.push({
        tipo: "EMPENHO_SEM_DOTACAO",
        descricao: "Empenho sem classifica\xC3\xA7\xC3\xA3o or\xC3\xA7ament\xC3\xA1ria identificada",
        pontuacao: 15,
        detalhes: `Registro: ${campo(row, "empenho", "numero", "nota", "id") || "N/D"} | Manual CGM \xC2\xA72.6 - Dota\xC3\xA7\xC3\xA3o or\xC3\xA7ament\xC3\xA1ria obrigat\xC3\xB3ria`
      });
    }
  }
  return alertas;
  ...
  for (const [sub, info] of porSubelemento) {
    if (info.valor > LIMITE_DISPENSA_SERVICOS && info.fornecedores.size > 1) {
      alertas.push({
        ...
        descricao: "Poss\xC3\xADvel fracionamento de despesa no mesmo subelemento (Res. TCE/SE 267/2011)",
        pontuacao: 20,
...
function regraSubelementoIncorreto(rows, classificacoes) {
  const alertas = [];
  for (const row of rows) {
    const vinculoRaw = campo(row, "vinculo", "v\xC3\xADnculo", "tipo_vinculo", "regime", "tipo_servidor", "tipo_contratacao", "categoria").toUpperCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    if (!vinculoRaw)
      continue;
    let vinculo = null;
    ...
    if (!classificacao.vinculos.includes(vinculo)) {
      ...
      alertas.push({
        ...
        descricao: `Subelemento de despesa incompat\xC3\xADvel com v\xC3\xADnculo do servidor (Res. TCE/SE 267/2011 + Portaria STN 448/2002)`,
        pontuacao: 20,
        detalhes: `Servidor: ${campo(row, "nome", "servidor", "credor", "beneficiario") || "N/D"} | V\xC3\xADnculo: ${vinculo} | Classifica\xC3\xA7\xC3\xA3o usada: ${codigoCompleto} (${classificacao.descricao}) | V\xC3\xADnculos v\xC3\xA1lidos p/ esta classifica\xC3\xA7\xC3\xA3o: ${classificacao.vinculos.join(", ")} | Classifica\xC3\xA7\xC3\xB5es corretas p/ ${vinculo}: ${corretas}`
      });
    }
  }
  return alertas;
...
function regraSubelementoIncorretoPdf(texto, classificacoes, regrasDb) {
  ...
  for (const codigo of codigosNd) {
    ...
    if (temEfetivo && !classificacao.vinculos.includes("EFETIVO") && classificacao.vinculos.includes("TEMPORARIO")) {
      alertas.push({
        tipo: "SUBELEMENTO_INCORRETO",
        descricao: "Servidor efetivo com classifica\xC3\xA7\xC3\xA3o de despesa de tempor\xC3\xA1rio (Res. TCE/SE 267/2011 + Portaria STN 448/2002)",
        pontuacao: 20,
        detalhes: `Classifica\xC3\xA7\xC3\xA3o encontrada: ${codigo} (${classificacao.descricao}) | V\xC3\xADnculo detectado: EFETIVO | Classifica\xC3\xA7\xC3\xA3o esperada: 31909401 (Indeniza\xC3\xA7\xC3\xB5es) ou 31901101 (Vencimento)`
      });
    }
    if (temTemporario && !classificacao.vinculos.includes("TEMPORARIO") && classificacao.vinculos.includes("EFETIVO")) {
      alertas.push({
        tipo: "SUBELEMENTO_INCORRETO",
        descricao: "Servidor tempor\xC3\xA1rio com classifica\xC3\xA7\xC3\xA3o de despesa de efetivo (Res. TCE/SE 267/2011 + Portaria STN 448/2002)",
        pontuacao: 20,
        detalhes: `Classifica\xC3\xA7\xC3\xA3o encontrada: ${codigo} (${classificacao.descricao}) | V\xC3\xADnculo detectado: TEMPORARIO | Classifica\xC3\xA7\xC3\xA3o esperada: 319004/31900401 (Contrata\xC3\xA7\xC3\xA3o por Tempo Determinado)`
      });
    }
    if (temComissionado && !classificacao.vinculos.includes("COMISSIONADO") && classificacao.vinculos.includes("EFETIVO") && !classificacao.vinculos.includes("TEMPORARIO")) {
      alertas.push({
        tipo: "SUBELEMENTO_INCORRETO",
        descricao: "Servidor comissionado com classifica\xC3\xA7\xC3\xA3o de despesa exclusiva de efetivo (Res. TCE/SE 267/2011 + Portaria STN 448/2002)",
        pontuacao: 20,
        detalhes: `Classifica\xC3\xA7\xC3\xA3o encontrada: ${codigo} (${classificacao.descricao}) | V\xC3\xADnculo detectado: COMISSIONADO | Classifica\xC3\xA7\xC3\xA3o esperada: 31901130 (Venc. cargo em comiss\xC3\xA3o) ou 31901113 (Gratifica\xC3\xA7\xC3\xA3o)`
      });
    }
  }
  if (temRescisao && temServidor) {
    let detalhesRescisao = "Rescis\xC3\xA3o de servidor efetivo: classifica\xC3\xA7\xC3\xA3o correta \xC3\xA9 3.1.90.94.01 (Indeniza\xC3\xA7\xC3\xB5es e Restitui\xC3\xA7\xC3\xB5es Trabalhistas). Rescis\xC3\xA3o de servidor tempor\xC3\xA1rio: classifica\xC3\xA7\xC3\xA3o correta \xC3\xA9 3.1.90.04.01 (Contrata\xC3\xA7\xC3\xA3o por Tempo Determinado). Verificar se o subelemento de despesa est\xC3\xA1 correto conforme o v\xC3\xADnculo do servidor.";
    if (regrasDb.length > 0) {
      const regrasRescisao = regrasDb.filter((r) => r.tipo_ato === "RESCISAO");
      if (regrasRescisao.length > 0) {
        detalhesRescisao = regrasRescisao.map((r) => `${r.vinculo_servidor}: ${r.codigo_completo} (${r.descricao}) \xE2\u20AC\u201D ${r.fundamentacao}`).join(" | ");
      }
    }
    alertas.push({
      tipo: "VERIFICAR_CLASSIFICACAO_RESCISAO",
      descricao: "Documento de rescis\xC3\xA3o de servidor \xE2\u20AC\u201D verificar classifica\xC3\xA7\xC3\xA3o or\xC3\xA7ament\xC3\xA1ria (Res. TCE/SE 267/2011 + Portaria STN 448/2002)",
      pontuacao: 15,
    ...
    if (temSolicitacaoDespesa) {
      alertas.push({
        ...
        descricao: "Rescis\xC3\xA3o com Solicita\xC3\xA7\xC3\xA3o de Despesa \xE2\u20AC\u201D conferir natureza da despesa e subelemento",
        pontuacao: 10,
        detalhes: "A Solicita\xC3\xA7\xC3\xA3o de Despesa (SD) para rescis\xC3\xA3o deve conter o subelemento correto: 31909401 para servidor efetivo, 31900401 para tempor\xC3\xA1rio. Conferir se o empenho foi classificado corretamente no Sistema Contabilis."
      });
    }
  }
  if (textoLower.includes("subelemento incorreto") || textoLower.includes("sub-elemento incorreto") || textoLower.includes("natureza da despesa incorreta")) {
    alertas.push({
      ...
      pontuacao: 15,
      detalhes: "Verificar classifica\xC3\xA7\xC3\xA3o conforme Res. TCE/SE 267/2011 e Portaria STN 448/2002"
    });
  }
  return alertas;
}
    ...
    for (let i = 1; i < itens.length; i++) {
      if (itens[i].dtPag < itens[i - 1].dtPag) {
        alertas.push({
          ...
          descricao: "Pagamento fora da ordem cronol\xC3\xB3gica de liquida\xC3\xA7\xC3\xA3o (Art. 141 Lei 14.133/2021)",
          pontuacao: 15,
    ...
    if (categoriasObjeto.size > 0 && categoriasCnae.size > 0) {
      ...
      if (!temOverlap) {
        alertas.push({
          ...
          descricao: "Objeto social (CNAE) possivelmente incompat\xC3\xADvel com o objeto contratado",
          pontuacao: 10,
...
function extrairCategorias(texto) {
  ...
  const mapa = {
    ...
    "saude": ["saude", "sa\xE2\u201D\u0153\xE2\u2022\u2018de", "medic", "hospitalar", "farmac", "enferm"],
    "educacao": ["educa", "escol", "ensino", "pedagog", "didatic"],
    "limpeza": ["limpeza", "conserva", "higien", "asseio"],
    "transporte": ["transport", "veicul", "ve\xE2\u201D\u0153\xC2\xA1cul", "locomo", "combust", "frota"],
    ...
    "locacao": ["aluguel", "loca\xE2\u201D\u0153\xC2\xBA\xE2\u201D\u0153\xC3\xBAo", "locacao"]
  };
  ...
  for (const [cnpj, info] of dados) {
    ...
    if (situacao !== "ATIVA") {
      alertas.push({
        ...
        descricao: "Empresa com situa\xC3\xA7\xC3\xA3o cadastral irregular na Receita Federal",
        pontuacao: 25,
        detalhes: `CNPJ: ${cnpj} | ${info.razao_social} | Situa\xC3\xA7\xC3\xA3o: ${situacao}`
      });
    }
  }
  return alertas;
...
function regraSociosEmComum(_rows, dados) {
  ...
  for (const [nome, empresas] of socioPorEmpresa) {
    ...
    alertas.push({
      ...
      descricao: "Fornecedores diferentes com s\xC3\xB3cios em comum",
      pontuacao: 20,
      detalhes: `S\xC3\xB3cio: ${nome} | Empresas: ${nomes.join(", ")}`
    });
  }
  return alertas;
}
  ...
  for (const row of rows) {
    ...
    if (sancionados.has(cnpj)) {
      alertas.push({
        ...
        descricao: "Empresa consta no CEIS/CNEP (Cadastro de Inid\xC3\xB4neas/Suspensas/Punidas)",
        pontuacao: 30,
...
function regraProcessoCombustivel(texto, paginasSemTexto = 0, totalPaginas = 0) {
  const alertas = [];
  ...
  if (temDanfe && !temNfe) {
    alertas.push({
      ...
      descricao: "DANFE presente sem a Nota Fiscal Eletr\xC3\xB4nica correspondente",
      pontuacao: 25,
      detalhes: "O DANFE \xC3\xA9 apenas o documento auxiliar da NF-e. A NF-e original deve estar acostada ao processo e com status AUTORIZADA pela SEFAZ.",
    ...
    alertas.push({
      ...
      descricao: "NF-e n\xC3\xA3o consta como AUTORIZADA pela SEFAZ",
      pontuacao: 25,
      detalhes: "A Nota Fiscal Eletr\xC3\xB4nica deve estar com status 'AUTORIZADA' no ambiente da SEFAZ. NF-e cancelada, denegada ou sem autoriza\xC3\xA7\xC3\xA3o n\xC3\xA3o \xC3\xA9 v\xC3\xA1lida para pagamento.",
      fundamentacao: "Ajuste SINIEF 07/2005; Decreto 6.022/2007"
    });
  }
  ...
  if (!temMapaAbastecimento) {
    alertas.push({
      ...
      descricao: "Processo de combust\xC3\xADvel sem Mapa de Controle de Abastecimento",
      pontuacao: 20,
      detalhes: "O Mapa de Controle de Abastecimento \xC3\xA9 documento obrigat\xC3\xB3rio em processos de combust\xC3\xADvel e deve ter quantidades e valores id\xC3\xAAnticos ao DANFE.",
      fundamentacao: "Princ\xC3\xADpio da transpar\xC3\xAAncia e controle interno (Art. 31 CF/88; Lei 4.320/64)"
    });
  }
  if (!temCupomFiscal) {
    alertas.push({
      tipo: "AUSENCIA_CUPOM_FISCAL",
      descricao: "Processo de combust\xC3\xADvel sem cupom fiscal",
      pontuacao: 15,
      detalhes: "O cupom fiscal deve acompanhar o processo com valores id\xC3\xAAnticos ao DANFE e ao Mapa de Controle de Abastecimento.",
  ...
  if (!temOrdemServico) {
    alertas.push({
      ...
      descricao: "Processo de combust\xC3\xADvel sem Ordem de Servi\xC3\xA7o",
      pontuacao: 15,
      detalhes: "A Ordem de Servi\xC3\xA7o deve acompanhar cada DANFE com dados id\xC3\xAAnticos ao DANFE, Mapa de Abastecimento e Cupom Fiscal.",
      fundamentacao: "Controle interno; Art. 31 CF/88"
    });
  }
  ...
  if (temControleKm) {
    ...
    if (temDestinoGenerico) {
      alertas.push({
        ...
        descricao: "Controle de quilometragem com destino gen\xC3\xA9rico \xE2\u20AC\u201D fere o princ\xC3\xADpio da transpar\xC3\xAAncia",
        pontuacao: 20,
        detalhes: 'O documento registra apenas "A servi\xC3\xA7o do TRE" sem especificar os locais de origem e destino de cada deslocamento. Isso viola o princ\xC3\xADpio da transpar\xC3\xAAncia pois n\xC3\xA3o permite verificar a veracidade dos percursos e quil\xC3\xB4metros registrados.',
        fundamentacao: "Princ\xC3\xADpio da transpar\xC3\xAAncia (Art. 37 CF/88); Lei 12.527/2011"
      });
    }
    ...
    if (percursos.length >= 2) {
      ...
      if (maxKm > 0 && minKm > 0 && maxKm / minKm >= 5) {
        alertas.push({
          ...
          descricao: "Inconsist\xC3\xAAncia grave na quilometragem do controle di\xC3\xA1rio",
          pontuacao: 25,
          detalhes: `Percursos com quilometragem extremamente discrepante (${minKm} km vs ${maxKm} km para trajetos similares). Verificar se os km percorridos conferem com as dist\xC3\xA2ncias reais entre os pontos informados.`,
          fundamentacao: "Princ\xC3\xADpio da veracidade e moralidade administrativa (Art. 37 CF/88)"
        });
      }
    }
    if (/9835.*9848|9848.*9849/s.test(texto)) {
      alertas.push({
        tipo: "INCONSISTENCIA_QUILOMETRAGEM",
        descricao: "Inconsist\xC3\xAAncia detectada: ida com 13 km e volta ao mesmo local com apenas 1 km",
        pontuacao: 25,
        detalhes: "Dia 19/03 \xE2\u20AC\u201D Sa\xC3\xADda PME (km 9835) \xE2\u2020\u2019 Maria Isabel (km 9848) = 13 km; Retorno Maria Isabel (km 9848) \xE2\u2020\u2019 PME (km 9849) = 1 km. Dist\xC3\xA2ncias incompat\xC3\xADveis para o mesmo percurso.",
        fundamentacao: "Princ\xC3\xADpio da veracidade e moralidade administrativa (Art. 37 CF/88)"
      });
    }
  }
  const certidoesObrigatorias = [
    ...
    { nome: "Certid\xE3o Judicial", regex: /certid[aã]o.*judicial|certid[aã]o.*c[ií]vel|a[cç][oõ]es judiciais/i, tipo: "CERTIDAO_JUDICIAL" }
  ];
  ...
  if (temPaginasEscaneadas && certidoesAusentes.length > 0) {
    alertas.push({
      ...
      descricao: `Certid\xF5es n\xE3o verific\xE1veis \u2014 ${paginasSemTexto} p\xE1gina(s) escaneada(s) sem texto extra\xEDdo`,
      pontuacao: 20,
      detalhes: `O processo cont\xE9m ${paginasSemTexto} p\xE1gina(s) em imagem (escaneadas) das quais o sistema n\xE3o consegue extrair texto sem OCR. As seguintes certid\xF5es n\xE3o foram localizadas no texto digital e podem estar nessas p\xE1ginas: ` + certidoesAusentes.map((c) => c.nome).join(", ") + `. Verificar manualmente se est\xE3o presentes e com validade em dia. Certid\xF5es exigidas: CND Municipal, CND Estadual, CRF/FGTS, CND Federal (RFB/PGFN), CNDT (Trabalhista) e Certid\xE3o Judicial.`,
    ...
    for (const certidao of certidoesAusentes) {
      alertas.push({
        ...
        descricao: `Processo de combust\xEDvel sem ${certidao.nome}`,
        pontuacao: 15,
        detalhes: `Em processos de pagamento de combust\xEDvel \xE9 obrigat\xF3ria a ${certidao.nome}. A certid\xE3o deve ser do domic\xEDlio da empresa (municipal e judicial/estadual conforme estado-sede do fornecedor).`,
        fundamentacao: "Lei 14.133/2021, art. 69"
      });
    }
  }
  ...
  const certVencidas = [];
  if (/fgts.*vencid|crf.*vencid|regularidade.*fgts.*vencid|vencid.*fgts/i.test(texto))
    certVencidas.push("CRF/FGTS");
  if (/estadual.*vencid|certid[aã]o.*estadual.*vencid|vencid.*estadual/i.test(texto))
    certVencidas.push("CND Estadual");
  if (/c[ií]vel.*vencid|judicial.*vencid|vencid.*judicial/i.test(texto))
    certVencidas.push("Certid\xE3o Judicial");
  if (/municipal.*vencid|cnd.*munic.*vencid|vencid.*municipal/i.test(texto))
    certVencidas.push("CND Municipal");
  if (/trabalhist.*vencid|cndt.*vencid|vencid.*trabalhist/i.test(texto))
    certVencidas.push("CNDT");
  if (/federal.*vencid|rfb.*vencid|pgfn.*vencid|vencid.*federal|vencid.*rfb/i.test(texto))
    certVencidas.push("CND Federal");
  if (certVencidas.length > 0) {
    alertas.push({
      tipo: "CERTIDAO_VENCIDA_COMBUSTIVEL",
      descricao: `Certid\xF5es VENCIDAS no processo de combust\xEDvel: ${certVencidas.join(", ")}`,
      pontuacao: 25,
      detalhes: `As certid\xF5es abaixo foram identificadas como vencidas. Certid\xF5es vencidas impedem o pagamento at\xE9 regulariza\xE7\xE3o: ${certVencidas.join(", ")}. Exigir certid\xF5es atualizadas dentro do prazo de validade.`,
      fundamentacao: "Lei 14.133/2021, art. 69; Art. 195, \xA73\xBA CF/88"
    });
  } else if (temVencida && certidoesDetectadas.length > 0) {
    alertas.push({
      tipo: "CERTIDAO_VENCIDA_COMBUSTIVEL",
      descricao: "Ind\xEDcio de certid\xE3o vencida no processo de combust\xEDvel",
      pontuacao: 20,
      detalhes: "O texto do processo cont\xE9m refer\xEAncia a vencimento/expira\xE7\xE3o pr\xF3ximo de certid\xF5es. As certid\xF5es devem estar v\xE1lidas na data do pagamento.",
      fundamentacao: "Lei 14.133/2021, art. 69; Art. 195, \xA73\xBA CF/88"
    });
  }
  ...
  if (!temNotaEmpenho) {
    alertas.push({
      ...
      pontuacao: 20,
      detalhes: "A Nota de Empenho \xC3\xA9 obrigat\xC3\xB3ria em toda despesa p\xC3\xBAblica. Havendo destaque/contrato, o Contrato e a Portaria de fiscaliza\xC3\xA7\xC3\xA3o/gest\xC3\xA3o devem referenciar os dados do fornecedor constantes na Nota Fiscal.",
  ...
  if (temContrato && !temPortariaFiscalizacao) {
    alertas.push({
      ...
      descricao: "Contrato sem Portaria de Fiscaliza\xC3\xA7\xC3\xA3o e Gest\xC3\xA3o identificada",
      pontuacao: 15,
      detalhes: "Contratos devem ter fiscal e gestor designados por portaria, com refer\xC3\xAAncia ao fornecedor destacado na Nota Fiscal.",
      fundamentacao: "Lei 14.133/2021, art. 117"
    });
  }
  return alertas;
}
__name(regraProcessoCombustivel, "regraProcessoCombustivel");
...
function parseTextoLivre(texto) {
  ...
  const termosChave = [
    ...
    "inexigibilidade",
    "emergencial",
    "licita\xC3\xA7\xC3\xA3o",
    "preg\xC3\xA3o",
    "tomada de pre\xC3\xA7o",
    "convite",
    "concorr\xC3\xAAncia",
    "aditivo",
    "contrato",
    "empenho",
    "liquida\xC3\xA7\xC3\xA3o",
    "pagamento",
    "nota fiscal",
    "reembolso",
    "fracionamento",
    ...
    "dfd",
    "etp",
    "termo de refer\xC3\xAAncia",
    "projeto b\xC3\xA1sico",
    "matriz de risco",
    "certid\xC3\xA3o",
    "atesto",
    "fiscal de contrato",
    ...
    "cno",
    "alvar\xC3\xA1",
    "medi\xC3\xA7\xC3\xA3o",
    "di\xC3\xA1ria",
    "reten\xC3\xA7\xC3\xA3o",
    "ir ",
    "iss",
    "inss",
    "fgts",
    "darf",
    "gps",
    "ordem cronol\xC3\xB3gica",
    // combustÃ­vel
    "danfe",
    "nf-e",
    "nota fiscal eletr\xC3\xB4nica",
    "autorizada",
    "mapa de controle de abastecimento",
    "cupom fiscal",
    "ordem de servi\xC3\xA7o",
    "controle di\xC3\xA1rio de quilometragem",
    "quilometragem",
    "certid\xC3\xA3o municipal",
    "certid\xC3\xA3o estadual",
    "certid\xC3\xA3o judicial",
    "certid\xC3\xA3o trabalhista",
    "cndt",
    "crf",
    "nota de empenho",
    "portaria de fiscaliza\xC3\xA7\xC3\xA3o",
    "gestor do contrato"
  ];
...
function regrasTextoLivre(texto, dados) {
  ...
  const termosRisco = [
    ...
    { termo: "dispensa de licita\xC3\xA7\xC3\xA3o", tipo: "MENCAO_DISPENSA", desc: "Documento menciona dispensa de licita\xC3\xA7\xC3\xA3o", pts: 5, fundamentacao: "Lei 14.133/2021, art. 75" },
    { termo: "inexigibilidade", tipo: "MENCAO_INEXIGIBILIDADE", desc: "Documento menciona inexigibilidade de licita\xC3\xA7\xC3\xA3o", pts: 5, fundamentacao: "Lei 14.133/2021, art. 74" },
    { termo: "emergencial", tipo: "MENCAO_EMERGENCIAL", desc: "Documento menciona contrata\xC3\xA7\xC3\xA3o emergencial", pts: 10, fundamentacao: "Lei 14.133/2021, art. 75, VIII" },
    { termo: "sem licita\xC3\xA7\xC3\xA3o", tipo: "MENCAO_SEM_LICITACAO", desc: "Documento menciona contrata\xC3\xA7\xC3\xA3o sem licita\xC3\xA7\xC3\xA3o", pts: 10, fundamentacao: "Lei 14.133/2021, art. 75" },
    ...
    { termo: "sem dfd", tipo: "AUSENCIA_DFD", desc: "Indica aus\xC3\xAAncia de Documento de Formaliza\xC3\xA7\xC3\xA3o da Demanda (DFD)", pts: 15, fundamentacao: "Lei 14.133/2021, art. 18" },
    { termo: "sem etp", tipo: "AUSENCIA_ETP", desc: "Indica aus\xC3\xAAncia de Estudo T\xC3\xA9cnico Preliminar (ETP)", pts: 15, fundamentacao: "Lei 14.133/2021, art. 18" },
    { termo: "sem termo de refer\xC3\xAAncia", tipo: "AUSENCIA_TR", desc: "Indica aus\xC3\xAAncia de Termo de Refer\xC3\xAAncia", pts: 15, fundamentacao: "Lei 14.133/2021, art. 18" },
    { termo: "sem projeto b\xC3\xA1sico", tipo: "AUSENCIA_PB", desc: "Indica aus\xC3\xAAncia de Projeto B\xC3\xA1sico", pts: 15, fundamentacao: "Lei 14.133/2021, art. 18" },
    // Empenho e liquidaÃ§Ã£o (Manual Â§2.6, Â§2.8)
    { termo: "empenho a posteriori", tipo: "EMPENHO_POSTERIORI", desc: "Empenho emitido ap\xC3\xB3s execu\xC3\xA7\xC3\xA3o da despesa (Art. 60 Lei 4.320/64)", pts: 20, fundamentacao: "Art. 60, Lei 4.320/64" },
    { termo: "empenho posterior", tipo: "EMPENHO_POSTERIORI", desc: "Empenho emitido ap\xC3\xB3s execu\xC3\xA7\xC3\xA3o da despesa", pts: 20, fundamentacao: "Art. 60, Lei 4.320/64" },
    { termo: "sem empenho", tipo: "SEM_EMPENHO", desc: "Despesa realizada sem empenho pr\xC3\xA9vio", pts: 25, fundamentacao: "Art. 60, Lei 4.320/64" },
    { termo: "sem atesto", tipo: "SEM_ATESTO", desc: "Liquida\xC3\xA7\xC3\xA3o sem atesto do fiscal/respons\xC3\xA1vel (Manual \xC2\xA72.8)", pts: 15, fundamentacao: "Lei 14.133/2021, art. 117" },
    ...
    { termo: "acr\xC3\xA9scimo de 25%", tipo: "ADITIVO_LIMITE", desc: "Refer\xC3\xAAncia ao limite de 25% de acr\xC3\xA9scimo em aditivos (Art. 125 Lei 14.133)", pts: 10, fundamentacao: "Lei 14.133/2021, art. 125" },
    // CertidÃµes (Manual Check Lists)
    { termo: "certid\xC3\xA3o vencida", tipo: "CERTIDAO_VENCIDA", desc: "Certid\xC3\xA3o com validade expirada", pts: 15, fundamentacao: "Lei 14.133/2021, art. 69" },
    { termo: "certid\xC3\xA3o negativa", tipo: "INFO_CERTIDAO", desc: "Documento menciona certid\xC3\xA3o negativa", pts: 0 },
    { termo: "cnd", tipo: "INFO_CERTIDAO", desc: "Refer\xC3\xAAncia a CND (Certid\xC3\xA3o Negativa de D\xC3\xA9bitos)", pts: 0 },
    // RetenÃ§Ãµes tributÃ¡rias (Manual Â§2.9/Â§2.12)
    { termo: "sem reten\xC3\xA7\xC3\xA3o", tipo: "AUSENCIA_RETENCAO", desc: "Poss\xC3\xADvel aus\xC3\xAAncia de reten\xC3\xA7\xC3\xA3o tribut\xC3\xA1ria obrigat\xC3\xB3ria", pts: 10, fundamentacao: "Lei 14.133/2021, art. 122" },
    { termo: "sem reten\xC3\xA7\xC3\xA3o de ir", tipo: "AUSENCIA_RETENCAO_IR", desc: "Aus\xC3\xAAncia de reten\xC3\xA7\xC3\xA3o de Imposto de Renda (IN RFB 1.234/2012)", pts: 15, fundamentacao: "IN RFB 1.234/2012" },
    { termo: "sem reten\xC3\xA7\xC3\xA3o de iss", tipo: "AUSENCIA_RETENCAO_ISS", desc: "Aus\xC3\xAAncia de reten\xC3\xA7\xC3\xA3o de ISS", pts: 10, fundamentacao: "Lei Complementar 116/2003" },
    { termo: "sem reten\xC3\xA7\xC3\xA3o previdenc", tipo: "AUSENCIA_RETENCAO_INSS", desc: "Aus\xC3\xAAncia de reten\xC3\xA7\xC3\xA3o previdenci\xC3\xA1ria (IN RFB 2.110/2022)", pts: 15, fundamentacao: "IN RFB 2.110/2022" },
    // Ordem cronolÃ³gica (Manual Â§2.9)
    { termo: "ordem cronol\xC3\xB3gica", tipo: "INFO_ORDEM_CRONOLOGICA", desc: "Refer\xC3\xAAncia \xC3\xA0 ordem cronol\xC3\xB3gica de pagamentos (Art. 141 Lei 14.133)", pts: 0, fundamentacao: "Lei 14.133/2021, art. 141" },
    { termo: "fora da ordem", tipo: "QUEBRA_ORDEM_CRONOLOGICA", desc: "Pagamento fora da ordem cronol\xC3\xB3gica", pts: 15, fundamentacao: "Lei 14.133/2021, art. 141" },
    // CotaÃ§Ã£o (Manual Â§2.4)
    { termo: "cota\xC3\xA7\xC3\xA3o \xC3\xBAnica", tipo: "COTACAO_INSUFICIENTE", desc: "Apenas uma cota\xC3\xA7\xC3\xA3o de pre\xC3\xA7os (m\xC3\xADnimo 3 obrigat\xC3\xB3rio - IN SEGES/ME 65/2021)", pts: 15, fundamentacao: "IN SEGES/ME 65/2021" },
    { termo: "pesquisa de pre\xC3\xA7o insuficiente", tipo: "COTACAO_INSUFICIENTE", desc: "Pesquisa de pre\xC3\xA7os insuficiente", pts: 15, fundamentacao: "IN SEGES/ME 65/2021" },
    // Obras (Manual Check Lists)
    { termo: "sem art", tipo: "AUSENCIA_ART", desc: "Obra sem ART (Anota\xC3\xA7\xC3\xA3o de Responsabilidade T\xC3\xA9cnica)", pts: 15, fundamentacao: "Lei 6.496/1977" },
    { termo: "sem rrt", tipo: "AUSENCIA_RRT", desc: "Obra sem RRT (Registro de Responsabilidade T\xC3\xA9cnica)", pts: 15, fundamentacao: "Resolu\xC3\xA7\xC3\xA3o CAU/BR 51/2013" },
    { termo: "sem cno", tipo: "AUSENCIA_CNO", desc: "Obra sem CNO (Cadastro Nacional de Obras)", pts: 10, fundamentacao: "IN RFB 1.845/2018" },
    { termo: "sem alvar\xC3\xA1", tipo: "AUSENCIA_ALVARA", desc: "Obra sem alvar\xC3\xA1 de constru\xC3\xA7\xC3\xA3o", pts: 15, fundamentacao: "Lei 14.133/2021, art. 8\xC2\xBA" },
    { termo: "sem medi\xC3\xA7\xC3\xA3o", tipo: "AUSENCIA_MEDICAO", desc: "Obra sem medi\xC3\xA7\xC3\xA3o/boletim de medi\xC3\xA7\xC3\xA3o", pts: 15, fundamentacao: "Lei 14.133/2021, art. 140" },
    // DiÃ¡rias (Manual Check Lists)
    { termo: "sem relat\xC3\xB3rio de viagem", tipo: "AUSENCIA_RELATORIO_VIAGEM", desc: "Di\xC3\xA1ria sem relat\xC3\xB3rio de viagem (prazo: 5 dias \xC3\xBAteis)", pts: 10, fundamentacao: "Lei 14.133/2021, art. 74" },
    { termo: "di\xC3\xA1ria", tipo: "INFO_DIARIA", desc: "Documento menciona di\xC3\xA1rias", pts: 0 },
    // Fracionamento
    { termo: "fracionamento", tipo: "MENCAO_FRACIONAMENTO", desc: "Documento menciona fracionamento de despesa", pts: 10, fundamentacao: "Lei 14.133/2021, art. 23, \xC2\xA75\xC2\xBA" },
    { termo: "sobrepre\xC3\xA7o", tipo: "MENCAO_SOBREPRECO", desc: "Documento menciona sobrepre\xC3\xA7o", pts: 15, fundamentacao: "Lei 14.133/2021, art. 59" },
    ...
    // Matriz de risco
    { termo: "sem matriz de risco", tipo: "AUSENCIA_MATRIZ_RISCO", desc: "Aus\xC3\xAAncia de Matriz de Risco (Art. 6\xC2\xBA, XXVII, Lei 14.133)", pts: 10, fundamentacao: "Lei 14.133/2021, art. 6\xC2\xBA, XXVII" },
    ...
    { termo: "natureza da despesa incorreta", tipo: "NATUREZA_DESPESA_INCORRETA", desc: "Natureza da despesa classificada incorretamente (Res. TCE/SE 267/2011)", pts: 20, fundamentacao: "Resolu\xC3\xA7\xC3\xA3o TCE/SE 267/2011" },
    ...
    { termo: "classifica\xC3\xA7\xC3\xA3o econ\xC3\xB4mica incorreta", tipo: "CLASSIFICACAO_INCORRETA", desc: "Classifica\xC3\xA7\xC3\xA3o econ\xC3\xB4mica da despesa incorreta (Res. TCE/SE 267/2011)", pts: 20, fundamentacao: "Resolu\xC3\xA7\xC3\xA3o TCE/SE 267/2011" },
  ...
  for (const v of dados.valores) {
    if (v > 5e5) {
      alertas.push({
        ...
        fundamentacao: "Lei 14.133/2021, art. 23, \xC2\xA71\xC2\xBA"
      });
    }
  }
      ...
      if (idxNF !== -1 && idxEmp !== -1 && idxNF < idxEmp) {
        if (datesParsed[0].dt.getTime() < datesParsed[1].dt.getTime()) {
          alertas.push({
            ...
            descricao: "Poss\xC3\xADvel NF emitida antes do empenho detectada no documento (Art. 60 Lei 4.320/64)",
            pontuacao: 15,
...
async function ocrViaAI(ai, imageBuffer) {
  try {
    const result = await ai.run("@cf/llava-hf/llava-1.5-7b-hf", {
      image: [...new Uint8Array(imageBuffer)],
      prompt: "Voc\xC3\xAA est\xC3\xA1 analisando um documento p\xC3\xBAblico brasileiro (controle de quilometragem, nota fiscal, DANFE, mapa de abastecimento, certid\xC3\xA3o ou similar). Extraia TODO o texto vis\xC3\xADvel na imagem: datas, hor\xC3\xA1rios, locais, quilometragens, valores, nomes, n\xC3\xBAmeros, siglas, assinaturas e cabe\xC3\xA7alhos. Transcreva exatamente como est\xC3\xA1 escrito, incluindo textos manuscritos. N\xC3\xA3o descreva a imagem \xE2\u20AC\u201D retorne apenas o texto extra\xC3\xADdo, linha por linha.",
      max_tokens: 4096
    });
...
__name(ocrViaAI, "ocrViaAI");
async function analisarImagem(input) {
  const alertas = [];
  if (!input.ai) {
    return {
      score: 0,
      ...
      alertas: [{
        ...
        descricao: "OCR n\xC3\xA3o dispon\xC3\xADvel \xE2\u20AC\u201D Workers AI n\xC3\xA3o configurado neste ambiente",
        pontuacao: 0,
        detalhes: "Para leitura de imagens \xC3\xA9 necess\xC3\xA1rio o Workers AI. Em produ\xC3\xA7\xC3\xA3o est\xC3\xA1 habilitado automaticamente."
      }],
  ...
  if (!textoOcr || textoOcr.length < 10) {
    return {
      ...
      alertas: [{
        tipo: "OCR_SEM_TEXTO",
        descricao: "N\xC3\xA3o foi poss\xC3\xADvel extrair texto da imagem",
        pontuacao: 0,
        detalhes: "A imagem pode estar muito escura, desfocada ou com resolu\xC3\xA7\xC3\xA3o insuficiente para leitura."
      }],
      resumo: { totalRegistros: 0, valorTotal: 0, registrosAnalisados: 0, textoExtraido: "" }
    };
  }
  ...
  return {
    ...
    resumo: {
      ...
      textoExtraido: textoOcr.substring(0, 15e3)
    },
    detalhesExtraidos: {
...
__name(analisarImagem, "analisarImagem");
...
async function uploadRoute(request, env, username) {
  ...
  if (!ALLOWED_TYPES.includes(fileType) && !ALLOWED_EXTENSIONS.includes(fileExt)) {
    return Response.json({ ok: false, message: "Tipo de arquivo n\xE3o permitido. Aceitos: PDF, CSV, XLSX, XML, JPG, PNG, WEBP, TIFF" }, { status: 400 });
  }
  ...
  try {
    ...
    ).bind(sanitizedName, fileType, file.size, resultado.score, resultado.nivel, JSON.stringify({ alertas: resultado.alertas, resumo: resultado.resumo, detalhesExtraidos: resultado.detalhesExtraidos }), key, username).run();
    return Response.json({
      ok: true,
...
async function reanaliseRoute(env, username, id) {
  ...
  await env.DB.prepare("UPDATE documentos SET score = ?, nivel = ?, alertas = ?, status = 'concluido' WHERE id = ?").bind(resultado.score, resultado.nivel, JSON.stringify({ alertas: resultado.alertas, resumo: resultado.resumo, detalhesExtraidos: resultado.detalhesExtraidos }), id).run();
